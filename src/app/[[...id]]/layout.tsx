...
export async function generateMetadata({ params }: { params: Promise<{ id: string }> }): Promise<Metadata> {
    ...
    try {
        ...
        const ROUTE_KEY = data.KEY_ROTA

        switch (true) {
            case ROUTE_KEY === ROUTE_KEYS.COMMON_INVITE_KEY:
            ...
            case ROUTE_KEY === ROUTE_KEYS.RESIDENT_REGISTER_KEY && data.CADASTRO_COMPLETO:
                title += "Cadastro completo";
                description = "Cadastro completo! Agora você pode aproveitar todos os benefícios do Livo App no seu condomínio.";
                url = `${BASE_PATH}/complete-register.jpg`
                break;

            case ROUTE_KEY === ROUTE_KEYS.RESIDENT_REGISTER_KEY:
                title += "Finalizar Cadastro";
                description = "Estamos quase lá! Complete seu cadastro e aproveite todos os benefícios do Livo App no seu condomínio.";
                url = `${BASE_PATH}/complete-register.jpg`
                break;

            case ROUTE_KEY === ROUTE_KEYS.REGISTER_PET_KEY:
            ...
            case ROUTE_KEY === ROUTE_KEYS.UPDATE_IMAGE_KEY:
