...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-[#141414] text-popover-foreground flex h-full w-full flex-col overflow-hidden rounded-lg",
        className
      )}
      {...props}
    />
...
function CommandInput({
  ...
  return (
    <div
      ...
      className="flex items-center gap-2 border px-3 h-10 rounded-lg bg-[#141414] font-light text-sm indent-[20px]"
    >
